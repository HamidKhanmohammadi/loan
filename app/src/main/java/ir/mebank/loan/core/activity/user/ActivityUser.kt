...
import ir.mebank.loan.core.module.ThemeHelper.Companion.getThemeDrawable
import ir.mebank.loan.core.module.makeView
import ir.mebank.loan.core.module.mspace

class ActivityUser : XActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setDrawerView(content())
    }
}
...
fun content() = makeView {
    verticalLayout {
        ...
        linearLayout {
            ...
            imageView(getThemeDrawable("uncox")) {
                onClick {
